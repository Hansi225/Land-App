...
<head>
    ...
    <title>About Us | Department of Land Settlement</title>

    <meta name="description" content="About the Department of Land Settlement Sri Lanka and its public land services.">
    ...
    <nav class="navbar">
        <div class="navbar-container">
            ...
            <ul class="nav-menu" id="navMenu">
                ...
                <li><a href="{{ route('about') }}" class="nav-link active" data-i18n="navAbout">About Us</a></li>
